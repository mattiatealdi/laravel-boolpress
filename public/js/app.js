...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getPosts: function getPosts() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('http://localhost:8000/api/posts', {
        params: {
          page: page
        }
      }).then(function (res) {
...
var render = function() {
  ...
  return _c("div", { staticClass: "container" }, [
    _c(
      ...
      { staticClass: "container" },
      [
        _c("h1", [_vm._v("I nostri Posts")]),
        _vm._v(" "),
        _vm._l(_vm.posts, function(post) {
          return _c("article", { key: post.id, staticClass: "mb-2" }, [
